...
using Microsoft.Dafny.CustomizedTreeVisitor;
namespace Microsoft.Dafny {
  ...
  public class DafnyDriver {
    ...
    public static bool Varify(Dafny.Program program) {
      Dictionary<string, PipelineStatistics> statss;
      PipelineOutcome oc;
      string baseName = "test";
      var boogiePrograms = Translate(program);
      return Boogie(baseName, boogiePrograms, null , out statss, out oc);
    }
    ...
    static ExitValue ProcessFiles(IList<DafnyFile/*!*/>/*!*/ dafnyFiles, ReadOnlyCollection<string> otherFileNames,
      ...
      HaosASTVisitor visitor = new HaosASTVisitor();
      visitor.Visit(dafnyProgram);

      // Console.WriteLine("This ends here");
      if (err != null) {
