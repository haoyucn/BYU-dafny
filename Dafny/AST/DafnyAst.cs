...
namespace Microsoft.Dafny {
  ...
  */
  ...
  public class BottomUpVisitor {
    public virtual void Visit(IEnumerable<Expression> exprs) {
      exprs.Iter(Visit);
    }
    public virtual void Visit(IEnumerable<Statement> stmts) {
      stmts.Iter(Visit);
    }
    public virtual void Visit(AttributedExpression expr) {
      Visit(expr.E);
    }
    public virtual void Visit(FrameExpression expr) {
      Visit(expr.E);
    }
    public virtual void Visit(IEnumerable<AttributedExpression> exprs) {
      exprs.Iter(Visit);
    }
    public virtual void Visit(IEnumerable<FrameExpression> exprs) {
      exprs.Iter(Visit);
    }
    public virtual void Visit(ICallable decl) {
    ...
    public virtual void Visit(SubsetTypeDecl ntd) {
      if (ntd.Constraint != null) Visit(ntd.Constraint);
      if (ntd.Witness != null) Visit(ntd.Witness);
    }
    public virtual void Visit(NewtypeDecl ntd) {
      if (ntd.Constraint != null) Visit(ntd.Constraint);
      if (ntd.Witness != null) Visit(ntd.Witness);
    }
  ...
  public class HaosVisitor: BottomUpVisitor {
    ...
    protected override void VisitOneStmt(Statement stmt) {
      Console.WriteLine("visited statement ");
    ...
    protected override void VisitOneExpr(Expression expr) {
      Contract.Requires(expr != null);
      // by default, do nothing
      Console.WriteLine("visited VisitOneExpr ");
