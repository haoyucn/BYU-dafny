  ...
  public partial class Translator {
    ...
    private Bpl.Program DoTranslation(Program p, ModuleDefinition forModule) {
      ...
      foreach (TopLevelDecl d in program.BuiltIns.SystemModule.TopLevelDecls) {
        ...
        //   Console.WriteLine("translator.DoTranslation with d.Attributes");
        //   Console.WriteLine(d.Attributes.Args.Count);
        //   for(int i = 0; i < d.Attributes.Args.Count; i++) {
        //     Console.WriteLine(d.Attributes.Args[i].GetType());
        //     Console.WriteLine(d.Attributes.Args[i].ToString());
        //     Console.WriteLine(d.Attributes.Args[i].tok.line);
        //     // Console.WriteLine(d.Attributes.Args[i].tok._filename);
        //     // Console.WriteLine(d.Attributes.Args[i].tok._line);
        //     // Console.WriteLine(d.Attributes.Args[i].tok._val);
        //     Console.WriteLine(d.Attributes.Args[i].ToString());
        //     Console.WriteLine(d.Attributes.Args[i].GetType());
        //   }
        // }
